            ...
            try
            {
                if (sender is Grid grid)
                {
                    ...
                    if (reminderText != null)
                    {
                        if (isNearRightEdge)
                        {
                            // If near the right edge, don't show the full text to avoid overflow
                            reminderText.Visibility = Visibility.Collapsed;
                        }
                        else
                        {
                        ...
                        Console.WriteLine($"MouseEnter: Set ReminderText to {reminderText.Visibility} for {grid.Name}");
                    }
                    
                    if (minutesBubble != null)
                    {
                        // Always show minutes bubble when hovering
                        minutesBubble.Visibility = Visibility.Visible;
                        Console.WriteLine($"MouseEnter: Set MinutesBubble to Visible for {grid.Name}");
                    }
                }
            }
            catch (Exception ex)
