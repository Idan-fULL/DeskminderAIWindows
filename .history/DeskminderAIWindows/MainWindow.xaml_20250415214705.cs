    ...
    public partial class MainWindow : Window
    {
        ...
        private void ExportReminders_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    // Get all reminders (including expired ones for historical record)
                    var remindersToExport = ViewModel.Reminders.ToList();
                    
                    // Export reminders using ReminderService
                    bool success = DeskminderAI.Services.ReminderService.ExportReminders(
                        remindersToExport, 
                    ...
                    {
                        MessageBox.Show(
                            $"התזכורות יוצאו בהצלחה אל {saveFileDialog.FileName}", 
                            "ייצוא הצליח", 
                            MessageBoxButton.OK, 
                    ...
                    {
                        MessageBox.Show(
                            "אירעה שגיאה בעת ייצוא התזכורות",
                            "שגיאת ייצוא",
                            MessageBoxButton.OK,
