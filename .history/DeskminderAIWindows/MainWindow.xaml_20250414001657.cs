    ...
    public partial class MainWindow : Window
    {
        ...
        private void TimerDragCanvas_MouseUp(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                if (_isDraggingDuration && TimerDragCanvas != null)
                {
                    ...
                    TimerDragCanvas.Background = new SolidColorBrush(WinColor.FromRgb(68, 68, 68));
        ...
        private void ChangeVisualState(string stateName)
        {
            try
            {
                ...
                if (ReminderPanel != null && ReminderPanel.Visibility == Visibility.Visible) ReminderPanel.Visibility = Visibility.Collapsed;
