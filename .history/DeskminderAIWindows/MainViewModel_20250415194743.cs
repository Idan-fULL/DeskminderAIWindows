    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        private void Timer_Tick(object? sender, EventArgs e)
        {
            ...
            foreach (var reminder in Reminders.ToList())
            {
                ...
                // Force a property changed notification for the reminder itself
                reminder.OnPropertyChanged(nameof(Reminder.TimeLeftDisplay));
                reminder.OnPropertyChanged(nameof(Reminder.TimeLeft));
            }
