    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_MouseDown(object sender, WinMouseButtonEventArgs e)
        {
            try
            {
                ...
                if (e.ChangedButton == MouseButton.Left && 
                    ...
                    !(e.OriginalSource is Border && ((Border)e.OriginalSource) == TimerDisplay))
                {
                    _isDragging = true;
        ...
        private void TimerDragCanvas_MouseDown(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                if (e.ChangedButton == MouseButton.Left)
                {
                    ...
                    _initialDragPosition = e.GetPosition(TimerDisplay).X;
                    ...
                    {
                        TimerDisplay.Background = new SolidColorBrush(WinColor.FromRgb(100, 175, 80));
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                if (TimerDisplay != null && ((UIElement)TimerDisplay).IsMouseCaptured)
                {
                    ((UIElement)TimerDisplay).ReleaseMouseCapture();
                }
            }
        }
        ...
        private void TimerDragCanvas_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                {
                    double currentX = e.GetPosition(TimerDisplay).X;
        ...
        private void TimerDragCanvas_MouseUp(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                if (_isDraggingDuration)
                {
                    ...
                    if (TimerDisplay != null)
                    {
                        TimerDisplay.Background = new SolidColorBrush(WinColor.FromRgb(51, 51, 51));
                    }
            ...
            try
            {
                ...
                switch (stateName)
                {
                    case STATE_ICON_ONLY:
                        ...
                        if (TimerCloseButton != null) TimerCloseButton.Visibility = Visibility.Collapsed;
                        if (TimerConfirmButton != null) TimerConfirmButton.Visibility = Visibility.Collapsed;
                    ...
                    case STATE_TIMER:
                        ...
                        if (TimerCloseButton != null) TimerCloseButton.Visibility = Visibility.Visible;
                        if (TimerConfirmButton != null) TimerConfirmButton.Visibility = Visibility.Visible;
                        if (ActiveRemindersPanel != null) ActiveRemindersPanel.Visibility = Visibility.Visible;
                        Width = 180;  // Maintain consistent width
                        Height = 300; // Taller to accommodate reminders
                        break;
                }
