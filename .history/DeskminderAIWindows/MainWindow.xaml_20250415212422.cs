    ...
    public partial class MainWindow : Window
    {
        ...
        private void ReminderContainer_MouseEnter(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                {
                    // The parent of ReminderContainer is now our root Grid
                    ...
                    // Find elements in the Canvas - they're children of the parent Grid
                    var canvas = parentGrid.Children.OfType<Canvas>().FirstOrDefault();
                    ...
                    // Show the reminder text - now that it's positioned in a Canvas,
                    // it won't affect the layout of other elements
                    if (reminderText != null)
                    {
