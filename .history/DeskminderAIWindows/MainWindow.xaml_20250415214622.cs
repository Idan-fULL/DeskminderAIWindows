    ...
    public partial class MainWindow : Window
    {
        ...
        private void ExportReminders_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("No reminders to export.", "Export Reminders", MessageBoxButton.OK, MessageBoxImage.Information);
                    return;
                }
                ...
                {
                    bool success = Services.ReminderService.ExportReminders(reminders, dialog.FileName);
                    if (success)
                    {
                        MessageBox.Show($"Successfully exported {reminders.Count} reminders to {dialog.FileName}", 
                            "Export Complete", MessageBoxButton.OK, MessageBoxImage.Information);
                    }
                    else
                    {
                        MessageBox.Show("Failed to export reminders. Please try again.", 
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"An error occurred: {ex.Message}", "Export Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
