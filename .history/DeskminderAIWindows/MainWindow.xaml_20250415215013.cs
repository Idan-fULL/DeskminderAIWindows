...
namespace DeskminderAI
{
    public partial class MainWindow : Window
    {
        ...
        private const double DEFAULT_POSITION_X = (SystemParameters.PrimaryScreenWidth / 2) - 50;
        private const double DEFAULT_POSITION_Y = 20;
        ...
        private void ExportReminders_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
                try
                {
                    ...
                    bool success = ReminderService.ExportReminders(reminders, saveFileDialog.FileName);
