        ...
        private void ReminderContainer_MouseEnter(object sender, MouseEventArgs e)
        {
            try
            {
                if (sender is Grid grid)
                {
                    ...
                    {
                        // Find the delete button in the Canvas
                        ...
                        if (deleteButton != null)
                        {
                            ...
                            Console.WriteLine("MouseEnter: Set DeleteButton to Visible");
                        }
                        
                        // Get the size of the window and the element's position
                        double screenWidth = SystemParameters.WorkArea.Width;
                        double elementRight = grid.TransformToAncestor(this).Transform(new System.Windows.Point(grid.ActualWidth, 0)).X;
                        ...
                        if (isNearRightEdge)
                        {
                            ...
                            Console.WriteLine("MouseEnter: Near edge, not showing expanded elements");
                        }
                        else
                        {
                            ...
                            if (reminderText != null)
                            {
                                ...
                                Console.WriteLine("MouseEnter: Set ReminderText to Visible");
                            }
                            ...
                            {
                                minutesBubble.Visibility = Visibility.Collapsed;
                                Console.WriteLine("MouseEnter: MinutesBubble kept Collapsed");
                            }
                        }
                    }
                }
                ...
                if (sender is Grid grid)
                {
                    ...
                    if (grid.Parent is Canvas canvas)
                    {
                        ...
                        if (deleteButton != null)
                        {
                            ...
                            Console.WriteLine("MouseLeave: Set DeleteButton to Hidden");
                        }
                        ...
                        if (reminderText != null)
                        {
                            ...
                            reminderText.Visibility = Visibility.Collapsed;
                            Console.WriteLine("MouseLeave: Set ReminderText to Collapsed");
                        }
                        ...
                        if (minutesBubble != null)
                        {
                            ...
                            minutesBubble.Visibility = Visibility.Collapsed;
                            Console.WriteLine("MouseLeave: Set MinutesBubble to Collapsed");
                        }
                    }
                }
            }
